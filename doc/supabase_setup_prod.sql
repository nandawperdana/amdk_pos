...
create table if not exists products (
  ...
  pack_buy_price double precision, pack_sell_price double precision,
...
-- --------------------------------------------------------------------------
-- Indexes: mirror lib/data/database/database.dart _createIndexes() so owner-
-- side report queries against this mirror don't full-scan as rows grow.
-- --------------------------------------------------------------------------
